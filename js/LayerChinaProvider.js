 ...
 */
  ...
  //     z: function() {
  //       return toLength(tilePoint.z, 2, 10)
  //     },
  //     x: function() {
  //       return toLength(tilePoint.x, 8, 16)
  //     },
  //     y: function() {
  //       return toLength(tilePoint.y, 8, 16)
  //     }
  //   }))
  // }
...
function toLength(num, length, base) {
  var trans = num.toString(base).toUpperCase()
  return (Array(length).join('0') + trans).slice(-length)
}
