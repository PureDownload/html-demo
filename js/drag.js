...
//     // 鼠标指针向对于浏览器页面（或客户区）的水平坐标。 获取元素刚开始时鼠标的坐标
//     x = e.clientX
//     y = e.clientY

//     // 其值等于父元素的margin + border + padding
//     l = divEl.offsetLeft
//     t = divEl.offsetTop
...
//     // 移动时鼠标坐标 - (元素刚开始时的位置 - 元素刚开始时的鼠标坐标)
//     var nl = nx - (x - l)
//     var nt = ny - (y = t)

//     console.info(',x',x,',y',y,',l',l,',t',t,',nx',nx,',ny',ny,',nl',nl,',nt',nt)

//     divEl.style.left = nl + 'px'
//     divEl.style.top = nt + 'px'
// }
